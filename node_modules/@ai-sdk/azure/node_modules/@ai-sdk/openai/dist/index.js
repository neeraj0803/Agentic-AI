        ...
        for (const part of content) {
          switch (part.type) {
            ...
            case "tool-call": {
              ...
              if ((caller == null ? void 0 : caller.type) === "program") {
...
var openaiBatchResponseSchema = lazySchema26(
  () => zodSchema26(openaiBatchResponseZodSchema())
);
...
var openaiBatchListResponseSchema = lazySchema26(
  () => zodSchema26(
    z28.object({
      data: z28.array(openaiBatchResponseZodSchema()),
      has_more: z28.boolean(),
      last_id: z28.string().nullish()
    })
  )
);
