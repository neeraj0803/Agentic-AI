...
// src/version.ts
var VERSION = true ? "5.0.40" : "0.0.0-test";
...
var imageMediaTypeSignatures = [
  {
    mediaType: "image/gif",
    bytesPrefix: [71, 73, 70, 56, 55, 97]
    // GIF87a
  },
  {
    mediaType: "image/gif",
    bytesPrefix: [71, 73, 70, 56, 57, 97]
    // GIF89a
  },
  {
    mediaType: "image/png",
  ...
  {
    mediaType: "image/bmp",
    bytesPrefix: [66, 77, null, null, null, null, 0, 0, 0, 0]
  },
  {
...
async function fetchWithValidatedRedirects({
  ...
  for (let redirectCount = 0; redirectCount <= maxRedirects; redirectCount++) {
    ...
    const location = (_a3 = response.headers) == null ? void 0 : _a3.get("location");
